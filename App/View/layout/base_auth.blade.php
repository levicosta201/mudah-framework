...
<head>
    ...
    <title>Dashboard || {{ $user_data->name }}</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('auth/dashboard') }}">
                ...
                <div class="sidebar-brand-text mx-3">{{ $user_data->name }} <sup>{{ $user_data->public_repos }}  {{ $user_data->public_repos > 1 ? 'repos' :  'repo'}}</sup></div>
            </a>
            <!-- Divider -->
            <hr class="sidebar-divider my-0">
            @include('layout.static.menu')
        </ul>
        <!-- End of Sidebar -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    @include('layout.static.top_search')

                    <!-- Topbar Navbar -->
                    @include('layout.static.top_nav_bar')
                </nav>
                <!-- End of Topbar -->

...
@section('content')
    <h1 class="h3 mb-4 text-gray-800">Adicionar Endereço</h1>
    <!-- DataTales Example -->
            ...
            <form>
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control" id="address" placeholder="R. aleatória N° 312">
                    </div>
                    <div class="form-group col-md-2">
                        <label for="inputPassword4">CEP</label>
                        <input type="text" class="form-control" id="postal_code" placeholder="12200-000">
                    </div>
                    <div class="form-group col-md-2">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input type="text" class="form-control" id="state" maxlength="2" placeholder="SP">
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-12">
                        <a href="#" id="btn-save-address" class="btn btn-success btn-icon-split">
                            ...
                            <span class="text">Salvar Endereço</span>
                        </a>
                    </div>
                </div>
            </form>
